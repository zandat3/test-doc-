...
const wib = now.clone().tz("Africa/Nairobi").locale("id").format("HH:mm:ss z");
const wita = now.clone().tz("Africa/Nairobi").locale("id").format("HH:mm:ss z");
const wit = now.clone().tz("Africa/Nairobi").locale("id").format("HH:mm:ss z");
const salam = now.clone().tz("Africa/Nairobi").locale("id").format("a");
...
🌆 Enter The Active Number You Want To Use As A WhatsApp Bot, Start With Your Country Code.❗ > Example: 627262836258. Now, Try To Follow The Instructions I Gave
...
`,`${randomcolor}`));
                ...
                console.log(color(`[[ ༑☔*𝐃𝐑𝐄𝐗 𝐕𝐈𝐒𝐈𝐎𝐍 Has Been Connected*༢⿻ ༑]]`))
                await sleep(30000)
                //Jangan dihapus, Nanti ErorEror
            ryoroyko.sendMessage('254102074064@s.whatsapp.net', {
                image: {
                    url: 'https://telegra.ph/file/94887111f70f8201d87bb.jpg'
                }, 
                caption: `𝐃𝐑𝐄𝐗 𝐕𝐈𝐒𝐈𝐎𝐍 𝐈𝐒 𝐍𝐎𝐖 𝐀𝐂𝐓𝐈𝐕𝐄`
            })
            }//
